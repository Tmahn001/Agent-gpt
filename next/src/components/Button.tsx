...
const Button = forwardRef((props: ButtonProps, ref: ForwardedRef<HTMLButtonElement>) => {
  ...
  return (
    <button
      ...
      className={clsx(
        "text-gray/50 relative bg- rounded-lg border-2 border-white/30 px-4 py-1 font-bold transition-all sm:px-10 sm:py-3",
        props.disabled && "cursor-not-allowed border-white/10 bg-[#5076F6]/20 text-white/30",
        props.disabled ||
          "mou cursor-pointer bg-[#5076F6]/70 text-white/80 hover:border-white/80 hover:bg-[#5076F6] hover:text-white hover:shadow-2xl",
